...
# The vocabulary and the token shapes moved to `app.domain.technologies` when the
# per-application resume derivation needed the same list. This module keeps the
# guard; the domain keeps the knowledge of what a technology looks like.
