...
class ApplicationEventType(StrEnum):
    ...
    # This application's own version of the resume was derived or edited. Kept
    # apart from RESUME_UPLOADED, which is about the PDF on the profile: one is
    # "the file the form attaches", the other "the resume this application
    # presents", and conflating them would make the trail unreadable.
