...
import { MasterResumeCard } from '@/components/MasterResumeCard';
import {
  Button,
  Card,
  CardHeader,
...
export function Profile() {
  ...
  return (
    <div className="space-y-5 pb-24">
      <PageHeader
        title="Perfil"
        description="O seu currículo principal. Tudo aqui alimenta a pontuação de vagas, as cartas de apresentação, as respostas de triagem — e a versão do currículo que cada candidatura monta para a vaga dela."
      />
      ...
      {/* The structured master resume saves itself, entry by entry, so it sits
          outside this page's draft and its sticky save bar. */}
      {profile ? <MasterResumeCard profile={profile} /> : null}
